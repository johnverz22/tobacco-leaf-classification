...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _confidenceText =
              "${(double.parse(data['confidence'].toString()) * 100).toStringAsFixed(1)}%";
          _hasResult = true;
        });
        ...
        setState(() {
          ...
          _confidenceText = "Please try again";
          _hasResult = true;
        });
      }
    } catch (e) {
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    Colors.black.withAlpha((.7 * 255).round()),
                    Colors.transparent,
                  ],
                ),
              ),
                  ...
                  _imageFile != null
                      ? GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Colors.black.withAlpha((.5 * 255).round()),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isPrimary
              ? Color(0xFF4CAF50)
              : Colors.white.withAlpha((.1 * 255).round()),
          borderRadius: BorderRadius.circular(25),
          border: Border.all(
            color: isPrimary
                ? Color(0xFF4CAF50)
                : Colors.white.withAlpha((.3 * 255).round()),
            width: 1,
          ),
        ),
        child: Column(
          children: [
            Icon(
              ...
              color: isPrimary
                  ? Colors.white
                  : Colors.white.withAlpha((.9 * 255).round()),
              size: 28,
            ),
            SizedBox(height: 8),
            Text(
              ...
              Row(
                children: [
                  Container(
                    padding: EdgeInsets.all(8),
                    decoration: BoxDecoration(
                      color: Color(0xFF4CAF50).withAlpha((.1 * 255).round()),
  ...
  Widget _buildResultCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: color.withAlpha((.05 * 255).round()),
        borderRadius: BorderRadius.circular(15),
        border: Border.all(
          color: color.withAlpha((.2 * 255).round()),
          width: 1,
        ),
      ),
      child: Row(
